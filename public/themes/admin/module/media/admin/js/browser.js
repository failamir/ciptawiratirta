...
window.uploaderModal = new Vue({
    ...
    data:{
        ...
        folders:[],
        breadcrumbs:[],
        accept_type:jobCore.media.groups.default.mime.join(',')
    },
    mounted(){
        let me = this;
    ...
    methods:{
        ...
        show(configs){
            ...
            this.accept_type = jobCore.media.groups[configs.file_type]['mime']
        },
        hide(){
            ...
            bookingCoreApp.showConfirm({
                ...
                callback: function(result){
                    if(result){
                        me.isLoading = true;
                        $.ajax({
                            url:jobCore.admin_url+'/module/media/removeFiles',
                            type:'POST',
                            data:{
        ...
        reloadLists(){
            ...
            me.isLoading = true;
            $.ajax({
                url:jobCore.admin_url+'/module/media/getLists',
                type:'POST',
                data:{
        ...
        upload(files){
            ...
            for(var i = 0; i < files.length ; i++){
                ...
                me.isLoading = true;
                $.ajax({
                    url:jobCore.admin_url+'/module/media/store',
                    data:d,
                    dataType:'json',
                    type:'post',
                    contentType: false,
        ...
        methods:{
            deleteFolder:function (){
              ...
              if(!c) return;
                ...
                this.saving = true;
                $.ajax({
                    url:jobCore.url+'/media/folder/delete',
                    data:{
                        id:this.folder.id,
                    },
                    type:'post',
            ...
            saveName:function(){
                ...
                this.saving = true;
                $.ajax({
                    url:jobCore.url+'/media/folder/store',
                    data:{
                        id:this.folder.id,
