            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="ls-widget mb-4">
                        <div class="tabs-box">
                            ...
                            <div class="widget-content">
                                ...
                                <hr>
                                @include('Candidate::admin.candidate.form',['row'=>$user,'show_phone'=>true,'show_birthday'=>true])
                            </div>
                        </div>
                    </div>
                    <div class="ls-widget mb-4">
                    ...
                    <div class="ls-widget mb-4 card-sub_information">
                        <div class="tabs-box">
                            <div class="widget-title"><h4>{{ __("Education - Experience - Award") }}</h4></div>
                            <div class="widget-content">
                ...
                <div class="col-lg-3">
                    <div class="ls-widget mb-4 ">
                        <div class="tabs-box">
                            <div class="widget-title"><h4>{{ __('Visibility')}}</h4></div>
                            <div class="widget-content">
                                <div class="form-group">
                                    <select required class="custom-select" name="allow_search">
                                        <option
                                            @if(old('allow_search',@$row->allow_search) =='hide') selected
                                            @endif value="hide"
                                        >{{ __('Hide')}}</option>
                                        <option
                                            @if(old('allow_search',@$row->allow_search) =='publish') selected
                                            @endif value="publish"
                                        >{{ __('Publish')}}</option>
                                    </select>
                                </div>
                    ...
                    <div class="ls-widget mb-4 ">
                        <div class="tabs-box">
                            <div class="widget-title"><h4>{{ __('Avatar')}}</h4></div>
                            <div class="widget-content">
                                <div class="form-group">
                    ...
                    <div class="ls-widget mb-4">
                        <div class="tabs-box">
                            <div class="widget-title"><h4>{{__("Skills")}}</h4></div>
                            <div class="widget-content">
                                <div class="form-group">
                                    <div class="">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        ...
                                        placeholder="{{__('Pinterest')}}"
                                        aria-label="{{__('Pinterest')}}"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        ...
                                        placeholder="{{__('Dribbble')}}"
                                        aria-label="{{__('Dribbble')}}"
