...
<script src="{{ asset('themes/superio/assets/js/jquery-ui.min.js') }}"></script>
...
<script src="{{ asset('themes/superio/assets/js/anm.min.js') }}"></script>
<script src="{{ asset('themes/superio/assets/js/owl.js') }}"></script>
<script src="{{ asset('themes/superio/assets/js/wow.js') }}"></script>
<script src="{{ asset('themes/superio/assets/js/script.js?_ver='.config('app.asset_version')) }}"></script>
