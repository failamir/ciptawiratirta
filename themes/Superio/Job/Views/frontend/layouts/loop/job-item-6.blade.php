...
<div class="inner-box">
    <div class="content">
        @if($row->company && $company_logo = $row->company->getLogoUrl())
            <span class="company-logo">
                <a href="{{ $row->company->getDetailUrl() }}"><img src="{{ $company_logo }}" alt="{{ $row->company->name }}" class="full-width object-cover"></a>
        </span>
        @endif
