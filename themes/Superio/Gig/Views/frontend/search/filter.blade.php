                ...
                <div class="form-group">
                    <div class="chosen-container chosen-container-single chosen-container-single-nosearch">
                        ...
                        <div class="dropdown-menu">
                            <div class="ml-3 mr-3 content-slider" style="width: 300px">
                                <div class="">
                                    <lable>
                                        {{ __("Min.") }} - {{ __("Max.") }}
                                    </lable>
                            ...
                            <div class="text-right ml-4 mr-4">
                                <button type="submit" class="btn btn-info btn-sm" onclick="this.form.submit()"> {{ __("Apply") }} </button>
                            </div>
                        </div>
                    </div>
                </div>
