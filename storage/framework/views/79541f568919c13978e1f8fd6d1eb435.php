...
<div class="widget-content">
    <ul class="job-overview">
        ...
        <?php endif; ?>
            <?php if($translation->qualification): ?>
                <li>
                    <i class="text-main text-22 icon flaticon-headhunting"></i>
                    <h5><?php echo e(__("Qualifications:")); ?></h5>
                    <span><?php echo nl2br(clean($translation->qualification)); ?></span>
                </li>
            <?php endif; ?>
    </ul>
</div>
<?php /**PATH /Users/imac/Sites/localhost/Superio.2.6.1/superio.2.6.1/themes/Superio/Job/Views/frontend/layouts/details/overview.blade.php ENDPATH**/ ?>