                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title"><?php echo e($themeClass::$name); ?>

                                    <?php if(\Modules\Theme\ThemeManager::current() == $theme_id): ?>
                                        <span class="badge badge-warning"><?php echo e(__("Current theme")); ?></span>
                                    <?php endif; ?>
                                </h5>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <?php if(\Modules\Theme\ThemeManager::current() == $theme_id): ?>
                                        <form class="d-none" onsubmit="return confirm('<?php echo e(__("Do you want to import all demo data?")); ?>')" action="<?php echo e(route('theme.admin.seeding',['theme'=>$theme_id])); ?>" method="post">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Layout::admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/imac/Sites/localhost/Superio.2.6.1/superio.2.6.1/modules/Theme/Views/admin/index.blade.php ENDPATH**/ ?>