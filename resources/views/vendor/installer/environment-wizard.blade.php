        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value=" {{ __("Site Name") }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('admin_email') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="admin_email" id="admin_email" value="" required placeholder="{{ __("Admin Email") }}" />
                ...
                <div class="form-group {{ $errors->has('admin_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="password" name="admin_password" id="admin_password" value="" required placeholder=" {{ __("Admin Password") }}" />
