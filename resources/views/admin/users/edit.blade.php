    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ktp') ? 'is-invalid' : '' }}" type="text" name="ktp" id="ktp" value="{{ old('ktp', $user->ktp) }}">
                @if($errors->has('ktp'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ktp') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visa') ? 'is-invalid' : '' }}" type="text" name="visa" id="visa" value="{{ old('visa', $user->visa) }}">
                @if($errors->has('visa'))
                    <div class="invalid-feedback">
                        {{ $errors->first('visa') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bst_ccm') ? 'is-invalid' : '' }}" type="text" name="bst_ccm" id="bst_ccm" value="{{ old('bst_ccm', $user->bst_ccm) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('b_o_d') ? 'is-invalid' : '' }}" type="text" name="b_o_d" id="b_o_d" value="{{ old('b_o_d', $user->b_o_d) }}">
                @if($errors->has('b_o_d'))
                    <div class="invalid-feedback">
                        {{ $errors->first('b_o_d') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('office_registered') ? 'is-invalid' : '' }}" name="office_registered_id" id="office_registered_id">
                    @foreach($office_registereds as $id => $entry)
                        <option value="{{ $id }}" {{ (old('office_registered_id') ? old('office_registered_id') : $user->office_registered->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::VC_YF_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('vc_yf') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="vc_yf_{{ $key }}" name="vc_yf" value="{{ $key }}" {{ old('vc_yf', $user->vc_yf) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::VC_COVID_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('vc_covid') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="vc_covid_{{ $key }}" name="vc_covid" value="{{ $key }}" {{ old('vc_covid', $user->vc_covid) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::CID_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cid') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cid_{{ $key }}" name="cid" value="{{ $key }}" {{ old('cid', $user->cid) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('coc') ? 'is-invalid' : '' }}" name="coc" id="coc">
                    ...
                    @foreach(App\Models\User::COC_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('coc', $user->coc) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('coc'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::RATING_ABLE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('rating_able') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="rating_able_{{ $key }}" name="rating_able" value="{{ $key }}" {{ old('rating_able', $user->rating_able) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::CCM_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('ccm') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="ccm_{{ $key }}" name="ccm" value="{{ $key }}" {{ old('ccm', $user->ccm) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('experiences') ? 'is-invalid' : '' }}" name="experiences[]" id="experiences" multiple>
                    @foreach($experiences as $id => $experience)
                        <option value="{{ $id }}" {{ (in_array($id, old('experiences', [])) || $user->experiences->contains($id)) ? 'selected' : '' }}>{{ $experience }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::APPLICATION_FORM_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('application_form') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="application_form_{{ $key }}" name="application_form" value="{{ $key }}" {{ old('application_form', $user->application_form) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_airport') ? 'is-invalid' : '' }}" type="text" name="home_airport" id="home_airport" value="{{ old('home_airport', $user->home_airport) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_code') ? 'is-invalid' : '' }}" type="text" name="post_code" id="post_code" value="{{ old('post_code', $user->post_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="number" name="weight" id="weight" value="{{ old('weight', $user->weight) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="number" name="height" id="height" value="{{ old('height', $user->height) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('birth_place') ? 'is-invalid' : '' }}" type="text" name="birth_place" id="birth_place" value="{{ old('birth_place', $user->birth_place) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department_applied') ? 'is-invalid' : '' }}" type="text" name="department_applied" id="department_applied" value="{{ old('department_applied', $user->department_applied) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::TESTIMONI_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('testimoni') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="testimoni_{{ $key }}" name="testimoni" value="{{ $key }}" {{ old('testimoni', $user->testimoni) === (string) $key ? 'checked' : '' }}>
