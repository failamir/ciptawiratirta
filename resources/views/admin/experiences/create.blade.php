    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.experiences.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_position') ? 'is-invalid' : '' }}" type="text" name="last_position" id="last_position" value="{{ old('last_position', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reason_leave') ? 'is-invalid' : '' }}" type="text" name="reason_leave" id="reason_leave" value="{{ old('reason_leave', '') }}">
