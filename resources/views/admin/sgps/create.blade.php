...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.sgp.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.sgps.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('crew_code') ? 'is-invalid' : '' }}" type="text" name="crew_code" id="crew_code" value="{{ old('crew_code', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('applied_position') ? 'is-invalid' : '' }}" name="applied_position_id" id="applied_position_id">
                    @foreach($applied_positions as $id => $entry)
                        <option value="{{ $id }}" {{ old('applied_position_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_o_b') ? 'is-invalid' : '' }}" type="text" name="d_o_b" id="d_o_b" value="{{ old('d_o_b', '') }}">
                @if($errors->has('d_o_b'))
                    <div class="invalid-feedback">
                        {{ $errors->first('d_o_b') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vc_yf') ? 'is-invalid' : '' }}" type="text" name="vc_yf" id="vc_yf" value="{{ old('vc_yf', '') }}">
                @if($errors->has('vc_yf'))
                    <div class="invalid-feedback">
                        {{ $errors->first('vc_yf') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vc_covid') ? 'is-invalid' : '' }}" type="text" name="vc_covid" id="vc_covid" value="{{ old('vc_covid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cid') ? 'is-invalid' : '' }}" type="text" name="cid" id="cid" value="{{ old('cid', '') }}">
                @if($errors->has('cid'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cid') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('coc') ? 'is-invalid' : '' }}" type="text" name="coc" id="coc" value="{{ old('coc', '') }}">
                @if($errors->has('coc'))
                    <div class="invalid-feedback">
                        {{ $errors->first('coc') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating_able') ? 'is-invalid' : '' }}" type="text" name="rating_able" id="rating_able" value="{{ old('rating_able', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ccm') ? 'is-invalid' : '' }}" type="text" name="ccm" id="ccm" value="{{ old('ccm', '') }}">
                @if($errors->has('ccm'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ccm') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('application_form') ? 'is-invalid' : '' }}" type="text" name="application_form" id="application_form" value="{{ old('application_form', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('int_by') ? 'is-invalid' : '' }}" name="int_by_id" id="int_by_id">
                    @foreach($int_bies as $id => $entry)
                        <option value="{{ $id }}" {{ old('int_by_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('int_date') ? 'is-invalid' : '' }}" type="text" name="int_date" id="int_date" value="{{ old('int_date') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Sgp::INT_RESULT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('int_result') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="int_result_{{ $key }}" name="int_result" value="{{ $key }}" {{ old('int_result', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('approved_as') ? 'is-invalid' : '' }}" name="approved_as_id" id="approved_as_id">
                    @foreach($approved_as as $id => $entry)
                        <option value="{{ $id }}" {{ old('approved_as_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
