...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.hotelExperience.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.hotel-experiences.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hotel_name') ? 'is-invalid' : '' }}" type="text" name="hotel_name" id="hotel_name" value="{{ old('hotel_name', '') }}">
