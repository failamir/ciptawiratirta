    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.references.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employers_name') ? 'is-invalid' : '' }}" type="text" name="employers_name" id="employers_name" value="{{ old('employers_name', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('address_and_email_contact_number') ? 'is-invalid' : '' }}" name="address_and_email_contact_number" id="address_and_email_contact_number">{!! old('address_and_email_contact_number') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('recommendation') ? 'is-invalid' : '' }}" name="recommendation" id="recommendation">{!! old('recommendation') !!}</textarea>
