...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.travelDocument.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.travel-documents.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type_of_document') ? 'is-invalid' : '' }}" name="type_of_document" id="type_of_document">
                    ...
                    @foreach(App\Models\TravelDocument::TYPE_OF_DOCUMENT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type_of_document', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('place_of_issuance') ? 'is-invalid' : '' }}" type="text" name="place_of_issuance" id="place_of_issuance" value="{{ old('place_of_issuance', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_issuance') ? 'is-invalid' : '' }}" type="text" name="date_of_issuance" id="date_of_issuance" value="{{ old('date_of_issuance') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_expiry') ? 'is-invalid' : '' }}" type="text" name="date_of_expiry" id="date_of_expiry" value="{{ old('date_of_expiry') }}">
