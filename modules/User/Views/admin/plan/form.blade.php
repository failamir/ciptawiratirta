...
<div class="form-group">
    <label class="control-label">{{__("Annual - Max Services")}} </label>
    <input type="number" min="0" value="{{old('annual_max_service',$row->annual_max_service)}}" name="annual_max_service" placeholder="{{__("Unlimited")}}" class="form-control">
    <p><i>{{__("How many publish services user can post")}}</i></p>
</div>
