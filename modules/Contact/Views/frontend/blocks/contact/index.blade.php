<div class="bravo-contact-block {{$class ?? ''}}">
    ...
    <div class="contact-section">
        <div class="auto-container">
            <div class="upper-box">
                <div class="row">
                    @if(!empty($contact_lists = setting_item_with_lang("page_contact_lists")) && empty($hide_contact_info))
    ...
    @if(empty($hide_recruiting))
    <div class="call-to-action style-two">
        <div class="auto-container">
            <div class="outer-box">
                <div class="content-column">
                    <div class="sec-title">
                        <h2>{{ setting_item_with_lang('contact_call_to_action_title') }}</h2>
                        <div class="text">{!! clean(setting_item_with_lang('contact_call_to_action_sub_title')) !!}</div>
                        <a href="{{ setting_item_with_lang('contact_call_to_action_button_link') }}" class="theme-btn btn-style-one bg-blue"><span class="btn-title">{{ setting_item_with_lang('contact_call_to_action_button_text') }}</span></a>
                    </div>
                </div>
