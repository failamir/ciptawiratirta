        ...
        <div class="panel">
            <div class="panel-body">
                ...
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="company_list_layout" class="form-control">
                                @foreach(config('company.list_layouts') as $layout=>$name)
                                    <option value="{{$layout}}" @if(setting_item('company_list_layout') == $layout) selected @endif >{{ $name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="single_company_layout" class="form-control">
                                @foreach(config('company.detail_layouts') as $layout=>$name)
                                    <option value="{{$layout}}" @if(setting_item('single_company_layout') == $layout) selected @endif >{{ $name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="" >{{__("Show attributes in loop")}}</label>
                        <div class="form-controls">
                            @foreach(app()->make(\Modules\Core\Models\Attributes::class)->query()->where("service", 'company')->get() as $attr)
                                <div>
                                    <label >
                                        <input type="checkbox" name="company_loop_attrs[]" value="{{$attr->id}}" @if(in_array($attr->id,setting_item_array('company_loop_attrs',[]))) checked @endif>
                                        {{$attr->name}}
                                    </label>
                                </div>
                            @endforeach
...
@include('Company::admin.settings.parts.review')
