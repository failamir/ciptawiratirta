@if(setting_item($row->type."_enable_review"))
    <div class="bravo-reviews" id="review-form">
                    ...
                    <div class="col-md-4 mb-4 mb-md-0">
                        <div class="border rounded flex-content-center py-5 border-width-2">
                            <div class="text-center">
                                ...
                                <div class="font-size-25 text-dark mb-3">{{$review_score['review_text']}}</div>
                            ...
                            @if(!empty($review_score['rate_score']))
                                @foreach($review_score['rate_score'] as $item)
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="flex-horizontal-center mr-6 d-flex align-items-center">
                                            <div class="progress bg-gray-33 rounded-pill w-100" style="height: 7px;">
                                                <div class="progress-bar rounded-pill" role="progressbar" style="width:{{$item['review_score'] * 2 * 10}}%;" aria-valuenow="" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                            <div class="ml-3 text-primary font-weight-bold">
                                                {{ number_format($item['review_score'],2) }}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
        ...
        <div class="py-4">
            @if(Auth::id())
                ...
                <div class="form-wrapper">
                    <form action="{{ route('review.store')}}" class="sfeedbacks_form" novalidate method="post">
                        @csrf
            ...
            @else
                <div class="review-message">
                    {!!  __("You must <a href='#login' class='bc-call-modal login'>log in</a> to write review") !!}
                </div>
            @endif
        </div>
    </div>
