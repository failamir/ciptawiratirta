    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                ...
                @php do_action(\Modules\Job\Hook::JOB_SETTING_AFTER_PAGE_TITLE) @endphp
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="jobs_list_layout" class="form-control">
                                ...
                                @endphp
                                @foreach(config('job.list_layouts', $list_layouts) as $key => $val)
                                    <option value="{{ $key }}" @if(setting_item('jobs_list_layout') == $key) selected @endif >{{ $val }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="job_single_layout" class="form-control">
                                ...
                                @endphp
                                @foreach(config('job.detail_layouts', $detail_layouts) as $key => $val)
                                    <option value="{{ $key }}" @if(setting_item('job_single_layout') == $key) selected @endif >{{ $val }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
