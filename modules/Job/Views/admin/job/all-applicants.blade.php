                                                ...
                                                <td>
                                                    @if($row->user)
                                                        <a href="{{ $row->candidateInfo->getDetailUrl().'?apply_id='.$row->id }}" target="_blank" class="candidate">
                                                            <img src="{{ $row->user->getAvatarUrl() }}" style="border-radius: 50%;max-width: 50px" class="company-logo" />
                                                                    ...
                                                                    <div class="info-form">
                                                                        <div class="applied-list">
                                                                            <div class="applied-item">
                                                                                ...
                                                                                <div class="val">
                                                                                    @if($row->candidateInfo and !empty($row->candidateInfo->user->getDisplayName()))
