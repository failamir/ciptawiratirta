                        ...
                        <div class="table-outer">
                            <table class="default-table manage-job-table">
                                ...
                                <tr>
                                    ...
                                    <th>{{ __("Status") }}</th>
                                    <th class="text-center applicant-actions">{{ __("Actions") }}</th>
                                </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <td>
                                                <div class="option-box">
                                                    <ul class="option-list">
                                                        <li><a class="" href="{{ route('candidate.detail', ['slug' => $row->candidateInfo->slug]) }}" data-text="{{ __("View Candidate Profile") }}"><span class="la la-user"></span></a></li>
