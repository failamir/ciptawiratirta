...
Route::get('/job-alert','JobAlertController@index')->name('job.admin.alert.index');
Route::post('/job-alert/editBulk','JobAlertController@editBulk')->name('job.admin.alert.bulkEdit');
