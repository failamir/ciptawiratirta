    ...
    <div class="col-lg-5">
        ...
        <div class="notification-widget ls-widget">
            <div class="widget-title">
                ...
                <a class="noti-view-all" href="{{ route('core.notification.loadNotify') }}">{{ __("View all") }}</a>
            </div>
            <div class="widget-content">
...
@section('footer')
    ...
    @if(file_exists(public_path('libs/moment/locale/' . app()->getLocale() . '.js')))
        <script src="{{url('libs/moment/locale/' . app()->getLocale() . '.js')}}"></script>
    @endif
