    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                ...
                @php $core = config('core'); @endphp
                @if(count($core['footer_style']) > 1)
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            ...
                            <select name="footer_style" class="form-control" >
                                @foreach($core['footer_style'] as $key => $val)
                                    <option value="{{ $key }}" @if($footer_style == $key) selected @endif>{{ $val }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls mb-3">
                        <input type="text" class="form-control" name="contact_call_to_action_title" placeholder="{{ __('Title') }}" value="{{ setting_item_with_lang('contact_call_to_action_title', request()->query('lang')) ?? "" }}">
                    </div>
                    <div class="form-controls mb-3">
                        <textarea name="contact_call_to_action_sub_title" class="form-control" placeholder="{{ __('Description') }}">{!! clean(setting_item_with_lang('contact_call_to_action_sub_title', request()->query('lang')) ?? '') !!}</textarea>
                    </div>
                    <div class="form-controls mb-3">
                        <input type="text" class="form-control" name="contact_call_to_action_button_text" placeholder="{{ __('Button Text') }}" value="{{ setting_item_with_lang('contact_call_to_action_button_text', request()->query('lang')) ?? "" }}">
                    </div>
                    <div class="form-controls mb-3">
                        <input type="text" class="form-control" name="contact_call_to_action_button_link" placeholder="{{ __('Button Link') }}" value="{{ setting_item_with_lang('contact_call_to_action_button_link', request()->query('lang')) ?? "" }}">
                    </div>
                    <div class="form-controls form-group-image">
                        {!! \Modules\Media\Helpers\FileHelper::fieldUpload('contact_call_to_action_image',setting_item_with_lang('contact_call_to_action_image', request()->query('lang'))) !!}
                    </div>
                </div>
