                ...
                <form method="post" action="{{ route("company.contact.store") }}"  class="bravo-contact-block-form">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                            <input type="text" name="name" value="{{$currentUser->display_name ?? ''}}" placeholder="{{__('Your Name')}}" required>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                            <input type="email" name="email" value="{{$currentUser->email ?? ''}}" placeholder="{{__('Email Address')}}" required>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
