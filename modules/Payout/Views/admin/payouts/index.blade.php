                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="pay_date" value="{{ !empty($payout->pay_date) ? date('Y-m-d', strtotime($payout->pay_date)) : '' }}" class="form-control has-datepicker" placeholder="{{__('YYYY/MM/DD')}}">
                                </div>
                            </div>
                            <div class="form-group">
...
@section('script.body')
    ...
    <script>
        ...
        $('.dungdt-form-payout-btn').click(function () {
            ...
            if(!ids || !ids.length){
                jobCoreApp.showError("{{__('Please select at lease one item')}}")
                return;
            }
        ...
        $('.dungdt-form-payout-save').click(function () {
            ...
            if(!status){
                jobCoreApp.showError("{{__("Status is empty")}}");
                return;
            }
            var ids = $('.check-item:checked').map(function(){
                return $(this).val();
