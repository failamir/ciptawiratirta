...
class GigController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['list_categories'] = GigCategory::query()->where('status', 'publish')->get()->toTree();
    ...
    public function category($slug){
        ...
        switch ($category->depth){
            ...
            default:
                ...
                $data['rows'] = Gig::search($filters)->with(['author'])->where('status','publish')->paginate(setting_item('gig_page_limit_item',24));
